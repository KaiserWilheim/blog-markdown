...
的数据结构，我们称之为大小为 $m \times m$ 的矩阵，可以简记为 $A_{m \times n}$ 。
...
的话，那么
$$
c_{i,j}=\sum_{k}^{\infty} \  a_{i,k} \times b_{k,j}
\tag{3.3.2}
$$
...
a_{2,1}b_{1,1}+a_{2,2}b_{2,1}+a_{2,3}b_{3,1} &  a_{2,1}b_{1,2}+a_{2,2}b_{2,2}+a_{2,3}b_{3,2} \\\\
a_{3,1}b_{1,1}+a_{3,2}b_{2,1}+a_{3,3}b_{3,1} &  a_{3,1}b_{1,2}+a_{3,2}b_{2,2}+a_{3,3}b_{3,2} \\\\
a_{4,1}b_{1,1}+a_{4,2}b_{2,1}+a_{4,3}b_{3,1} &  a_{4,1}b_{1,2}+a_{4,2}b_{2,2}+a_{4,3}b_{3,2}
\end{bmatrix} \notag
\end{gather}
\tag{3.3.3}
\label{dt}
